...
import prefuse.action.assignment.DataColorAction; //newly added import
...
public class RadialGraphView extends Display {
    ...
    public RadialGraphView(Graph g, String label) {
        ...
        m_vis.setRendererFactory(rf);  // return the name label renderer as the default for all non-EdgeItems
               
        // -- set up processing actions --
        
        
        //------------------NEWLY ADDED CODE to set the color of the rectangle--------------------//
  ...
  //      recolor.add(fill);//newly added
    ...
    public static class NodeColorAction extends ColorAction {
        ...
        public NodeColorAction(String group) {
            ...
            super(group, VisualItem.FILLCOLOR, ColorLib.rgb(250,0,0));  //the color part was previously ColorLib.rgba(255,255,255,0)
    ...
    public static class TextColorAction extends ColorAction {
        public TextColorAction(String group) {
            super(group, VisualItem.TEXTCOLOR, ColorLib.rgb(0,150,255)); //this set the text color initially the code was : ColorLib.gray(0)
            add("_hover", ColorLib.rgb(255,0,0));   //this set the color of the text when mouse is over it
            
            //how to change the color of each text in RadialGraphView.java
